...
**Daily Alerts remains the timeline tab.** It has no data source of its own: it re-reads **four** of the
...
public/js/
  ...
  data/                    one module per feed: load once, compute once, cache, expose accessors
                           ...
                           daily-alerts.js — retained chronological readings across four tabs (§4d)

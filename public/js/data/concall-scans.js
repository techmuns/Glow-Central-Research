...
async function build() {
  ...
  //    configured Screener outage repaints an empty Upcoming view from the stored response, which is the
 ...
 * authenticated configured Screener dashboard captured into an immutable Actions artifact. Either fails on

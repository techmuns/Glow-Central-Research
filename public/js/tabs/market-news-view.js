...
let listView = { q: '', section: 'all', topic: 'all' };
let fillStop = null;
        ...
        get: (r) =>
          r.__banner
            ? `REAL REPORTING, NOT OURS. Market-wide stocks news from the publisher's own listing, ` +
              ...
              `TRACKED TOPICS ARE OURS: a keyword reading of what a story is about, never a direction and never a score. ` +
              `These stories carry no company, so a topic here names a subject and cannot say it is one of yours. ` +

...
const WORKSPACES = [
  { id: 'research', label: 'Research Central', tabs: [macroResearch, economyMacro, familyBook, askResearch, aiAlerts, dailyAlerts, earningsHub, concall, publicChatter, breakouts, superInvestors, mutualFunds, news, corpAnnouncements, insiderTrades] },

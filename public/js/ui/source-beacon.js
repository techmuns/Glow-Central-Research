...
// single Glow Research square. It is a shop window for a fact that is otherwise invisible: this
    ...
    <div class="beacon-flow">
      <div class="beacon-flow-stage" style="width:${FLOW.w}px;height:${flow.h}px;--beacon-join-x:${((FLOW.joinX / FLOW.w) * 100).toFixed(3)}%;--beacon-join-y:${((flow.joinY / flow.h) * 100).toFixed(3)}%">
        ...
        <div class="beacon-core">
          ...
          <span class="beacon-mark beacon-mark-lg" aria-hidden="true"><img class="sattva-mark" src="/assets/brand/favicon.svg" width="420" height="174" alt="" /></span>
        </div>
      </div>
      <div class="beacon-flow-caption">
        <div class="beacon-flow-title">Glow Research</div>
...
function launcherHtml(estate) {
  return `
    <button type="button" class="beacon-launcher" data-beacon-toggle
      ...
      <span class="beacon-mark" aria-hidden="true"><img class="sattva-mark" src="/assets/brand/favicon.svg" width="420" height="174" alt="" /></span>

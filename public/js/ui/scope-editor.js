...
<<<<<<< HEAD
            ${scope === 'portfolio' ? 'Your holdings from GlowVentures statements. Published statement changes update automatically.' : 'Search by company name or ticker, then add or remove it. Changes are kept on this device.'}
=======
            ${scope === 'portfolio'

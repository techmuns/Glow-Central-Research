...
const CACHE_KEY = `${CACHE_NAME}-news-story-companions-v1-telegram-content-v1-watchlist-reliability-v4-sme-scope-v1-alert-arrivals-v3-notification-inbox-v1-breakout-layout-v1-all-alerts-restore-v2-ai-card-updates-v1-story-updates-v2-shared-reading-performance-ownership-v1-sattva-newsletter-v3-source-evidence-bounded-history-memory-v5-hot-path-caches-v1-sliced-rankings-v1-alert-pool-v2-scrollbar-grab-v1-filing-particulars-v1-table-drag-v2-mutual-funds-v12-upstox-minute-v2-muns-price-label-v2-kpi-impact-v2`;

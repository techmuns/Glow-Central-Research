...
const CACHE_KEY = `${CACHE_NAME}-glow-table-scrollbars-v1-glow-order-book-topic-v1-glow-alert-filters-v1-glow-portfolio-reader-v3-glow-investor-dates-v1-telegram-content-v1-watchlist-reliability-v4-sme-scope-v1-alert-arrivals-v3-notification-inbox-v1-breakout-layout-v1-all-alerts-restore-v2-ai-card-updates-v1-performance-ownership-v1-ai-impact-triggers-v1-mf-active-passive-v4-ai-impact-links-v1-glow-newsletter-simple-v1-glow-newsletter-multi-add-v1-glow-newsletter-coverage-v1-glow-research-settle-v1-sattva-newsletter-v2-bounded-history-memory-v5-hot-path-caches-v1-sliced-rankings-v1-alert-pool-v1`;

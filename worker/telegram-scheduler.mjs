...
export const TELEGRAM_PRODUCTION_HOST = 'glow-central-research.tech-441.workers.dev';
const KEY = 'schedule';
const REPO = 'techmuns/Glow-Central-Research';
...
export class TelegramSchedule {
  ...
  async request(source = 'auto') {
    ...
    try {
      ...
      const cfg = { token: this.env.GH_DISPATCH_TOKEN, owner: 'techmuns', repo: 'Glow-Central-Research', ref: 'main', now: this.now };

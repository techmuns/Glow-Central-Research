...
if (!process.argv.includes('--dry')) throw new Error('Glow identities are produced by build-book.mjs. The upstream workbook resolver is available only with --dry for regression checks.');

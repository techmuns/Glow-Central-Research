...
try {
  ...
  assert.deepEqual(after, ['sattva-dashboard-fixture-next-release-glow-portfolio-reader-v1-telegram-content-v1'], 'a later shared marker upgrades and evicts the previous combined cache');

#!/usr/bin/env node
/**
 * Mirror the current listed portfolio into the configured Glow watchlist.
...
try {
  ...
  await report(`FAIL: configured Screener sync stopped during ${stage}. No credentials or portfolio identifiers were logged.`);
  process.exitCode = 1;
} finally {

...
function artifactFetch({ digest = null, host = 'https://example.blob.core.windows.net/capture', event = 'schedule', payload = capture } = {}) {
  ...
  const run = { id: 10, path: '.github/workflows/screener-insights-refresh.yml', head_branch: 'main', head_repository: { full_name: 'techmuns/Glow-Central-Research' }, event, status: 'completed', conclusion: 'success' };

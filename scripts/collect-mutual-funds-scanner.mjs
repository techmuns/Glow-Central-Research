...
export async function scannerFetch(url,{fetcher=fetch}={}) {
  ...
  let response;
  try { response=await fetcher(url,{headers:{accept:'text/html','user-agent':'SattvaResearch/1.0 (+https://github.com/techmuns/Glow-Central-Research)'},redirect:'manual',signal:AbortSignal.timeout(30000)}); }

...
writeFileSync(config,JSON.stringify({name:'summary-local-test',main:join(scratch,'entry.mjs'),compatibility_date:'2026-05-23',
  vars:{SCREENER_SUMMARIES_ENABLED:'true',GH_REPO:'techmuns/Glow-Central-Research',GH_REF:'main',GH_DISPATCH_TOKEN:'fixture'},durable_objects:{bindings:[{name:'SUMMARIES',class_name:'SummaryTest'}]},migrations:[{tag:'v1',new_sqlite_classes:['SummaryTest']}]}));
let child,logs='';
